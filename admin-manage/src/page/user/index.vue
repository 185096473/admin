  ...
  <div>
    <div class="filter-container">
      <el-row>
        ...
        <el-select @change="selectChange" v-model="selectValue" placeholder="状态">
          <el-option
  ...
  methods: {
    ...
    selectChange(val) {
       ...
       console.log(this.selectValue)
        // this.$refs.child.handleSelectionChange(this.tableData)
      //  console.log(this.gethandleSelectionChange())
    },
    searchCondition() {
      return {
